...
![image](https://www.greatfrontend.com/img/questions/job-board/job-board-example.png)
...
#
#
### API Details:  Hacker News has a public API to fetch jobs posted by Y Combinator companies
#
#
#### 1. Job Stories (Fetches a list of job posting IDs.)

- URL: https://hacker-news.firebaseio.com/v0/jobstories.json
- HTTP Method: GET
- Content Type: json

Sample response for:https://hacker-news.firebaseio.com/v0/jobstories.json
```sh
 [35908337, 35904973, 35900922, 35893439, 35890114, 35880345, ...]
```
#### 2. Job Details (Fetches job  details for given JobID.)
